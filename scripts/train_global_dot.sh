...
#chmod +x scripts/train_global.sh
#tmux new-session -d -s nmt_train \
#"bash scripts/train_global.sh 2>&1 | tee train_T1_base_reverse_nmt_global_location_feedinput$(date +%Y%m%d_%H%M%S).log"
...
work_dir="/workspace/T4_global_dot"
